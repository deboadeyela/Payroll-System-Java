...
public final class HourlyWorker extends Employee {
	...
	public HourlyWorker(String first, String last, double wagePerHour, double hoursWorked, int year, int month, int day,
	...
	public void setWage(double wagePerHour) {
		// Ternary operation that checks if there is a wagePerHour and assigns it that.
